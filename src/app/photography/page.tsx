...
export default function PhotographyPage() {
  const subServices = [
    ...
    "Photo Editing & Video Post-Production",
  ];
  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col items-center py-16 px-6">
      ...
      <section className="max-w-4xl text-center mb-16">
        ...
        <Image
          src="/images/banner/photography-banner.jpg" // placeholder image path
      ...
      <section className="text-center">
        ...
        <p className="text-gray-700 mb-6">
          Offer your photography and videography services on OsMan and connect with clients worldwide.
        </p>
        <Link
